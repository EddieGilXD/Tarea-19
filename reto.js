...
Todo parece funcionar correctamente. ¿Qué pasaría si quisiéramos añadir
un nuevo método a nuestro objeto goat llamado .diet() que imprima
...
const goat1 = {
  ...
  goat1.diet(); 
  // Output: ReferenceError: dietType is not defined
 ...
 * acceso automático a otras propiedades del objeto goat1.
 * 
 ...
 * propiedad de modelo y le asignaremos el valor de 'B-4MI'.
 * Agrega otra propiedad, energyLevel y asígnale el valor 100.
 * 
 * const robot = {
     ...
     Dentro del objeto robot, agrega un método llamado provideInfo. 
     Dentro del cuerpo de provideInfo(), devuelve la siguiente cadena 
     mediante interpolación:

     I am MODEL and my current energy level is ENERGYLEVEL.  

     Reemplaza 'MODEL' y 'ENERGYLEVEL' con la propiedad model y el objeto 
     que realiza la llamada energyLevel. Recuerda que, para acceder a las 
     propiedades del objeto que realiza la llamada dentro de un método, 
     debes usar la palabra clave this.



     Ahora, para comprobar .provideInfo() si tiene acceso a las propiedades
    internas de robot. Registra el resultado de la llamada .provideInfo() 
...
Objetos específicos del navegador (como localStorage, 
navigator).
